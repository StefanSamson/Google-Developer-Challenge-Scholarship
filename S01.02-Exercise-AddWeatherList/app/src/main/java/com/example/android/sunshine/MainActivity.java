...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] fakeWeatherArray = new String[100];
        for (int i = 0; i < 100; i++) {
            fakeWeatherArray[i] = String.format("Fake weather %s", i);
        }

        // TODO (4) Append each String from the fake weather data array to the TextView
        for (String forecast : fakeWeatherArray) {
            mWeatherDisplayTextView.append(forecast);
            mWeatherDisplayTextView.append("\n");
        }
    }
}