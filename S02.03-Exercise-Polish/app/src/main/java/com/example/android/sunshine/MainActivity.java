...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mErrorLoadingContentTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mErrorLoadingContentTextView = (TextView) findViewById(R.id.activity_forecast_tv_error_loading_content);

        // TODO (17) Find the ProgressBar using findViewById
        mLoadingContentProgressBar = (ProgressBar) findViewById(R.id.activity_forecast_pb_loading_content);
    ...
    private void showWeatherDataView() {
        mErrorLoadingContentTextView.setVisibility(View.GONE);
    ...
    private void showErrorMessage() {
        ...
        mErrorLoadingContentTextView.setVisibility(View.VISIBLE);
    }

    private void setLoadingContentProgressBarVisibility(boolean newVisibility) {
        mLoadingContentProgressBar.setVisibility(newVisibility ? View.VISIBLE : View.GONE);
    }
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPreExecute() {
            setLoadingContentProgressBarVisibility(true);
        }
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            setLoadingContentProgressBarVisibility(false);
