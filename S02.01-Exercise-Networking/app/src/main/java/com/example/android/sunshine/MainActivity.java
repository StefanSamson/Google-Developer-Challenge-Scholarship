...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        new WeatherNetworkRequestTask().execute(SunshinePreferences.getPreferredWeatherLocation(this));
    }

    // TODO (5) Create a class that extends AsyncTask to perform network requests
    private class WeatherNetworkRequestTask extends AsyncTask<String, Void, String> {
